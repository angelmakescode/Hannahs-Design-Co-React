        ...
        <div className="footer-max-width max-content-container">
          <div className="footer-container">
            ...
            <div className="footer-social-media">
              <span className="footer-text01">Follow us</span>
          ...
          <div className="footer-links">
            <div className="footer-container2">
              ...
              <span className="footer-text07 footer-link">Pricing</span>
            </div>
            <div className="footer-container3">
              <span className="footer-text08">Resources</span>
              <span className="footer-link">Feed Reader App</span>
              <span className="footer-link">Download Feedbox</span>
              <span className="footer-link">Mail browser app</span>
              <span className="footer-link">iOS Version</span>
              <span className="footer-text13 footer-link">Android Version</span>
            </div>
          </div>
        </div>
      </footer>
